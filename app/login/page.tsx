              ...
              return (
                <div key={provider.id} className="text-center">
                  <button
                    ...
                    disabled={loading}
                    className="bg-gray-900 hover:bg-gray-700 disabled:bg-gray-500 text-white font-bold py-2 px-4 rounded flex items-center justify-center w-full transition-colors"
                  >
                    <svg
                      role="img"
                      viewBox="0 0 24 24"
